...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, principal: Principal):
        ...
        assertions.assert_valid(len(assignment.content) != 0 , 'assignment with empty content cannot be submitted')
    ...
    '''added'''
    @classmethod
    def assignment_grade(cls, _id, grade, principal: Principal):
        assignment = Assignment.get_by_id(_id)
